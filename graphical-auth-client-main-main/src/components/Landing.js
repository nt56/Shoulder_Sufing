      ...
      <div className="flex-col md:flex-row flex justify-around mt-8 sm:mt-16 font-['Work_Sans']">
        ...
        <div className="text-white ml-8 mt-8">
          ...
          <button
            ...
            className="transition duration-500 ease-in-out sm:w-1/3 bg-[#A259FF] rounded-lg px-4 py-1 mt-6 sm:text-xl border-[#A259FF] border-2 hover:bg-transparent">
        ...
        <div className="hidden sm:block">
          <img
            alt=""
            className=" hover:scale-95 transition duration-500 ease-in-out hover:shadow-2xl hover:shadow-[#A259FF80] rounded-[25px] w-full"
            src="https://i.pinimg.com/736x/67/a1/a1/67a1a1b9b21505a42648010e3669076e.jpg"
          />
        </div>
      </div>
