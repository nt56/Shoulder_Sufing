...
export default function Footer(props) {
  ...
  return (
    <div className="bg-[#3B3B3B] lg:mt-60">
      <div className="bg-[#3B3B3B] mt-24 flex justify-around flex-col sm:flex-row">
        ...
        <div className="ml-4 sm:ml-0 text-white mt-6">
          ...
          <p onClick={() => props.setPage(Page.ABOUT)} className="text-gray-300 font-['Work_Sans'] mt-2 sm:mt-4 cursor-pointer">
            About Us
          </p>
          <p onClick={() => props.setPage(Page.CONTACT)} className="text-gray-300 font-['Work_Sans'] cursor-pointer">
            Contact
          </p>
        </div>
        ...
        <div className="hidden sm:block text-white mt-6">
          ...
          <div className="flex font-['Work_Sans']">
            ...
            <button
              ...
              className="transition duration-300 ease-in w-1/3 bg-[#A259FF] rounded-lg mt-4 border-[#A259FF] px-1 border-2 hover:bg-transparent z-20 hover:z-0 -ml-4">
              Subscribe
            </button>
          </div>
        </div>
      ...
      <p className="mt-2 text-[#9b9b9b] sm:text-md text-sm text-center pb-4">© ALTAF SHAIKH, NISHANT PAWAR, AAMIR SHAIKH, RAKESH MOREALTAF SHAIKH</p>
    </div>
  );
}
